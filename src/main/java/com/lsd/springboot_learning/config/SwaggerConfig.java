...
//                .apis(RequestHandlerSelectors.basePackage("com.lsd.springboot_learning.controller")).paths(PathSelectors.any())
...
//     */
//
//    // setToken方法，代表生成文档的所有接口中，都要包含一个header类型的token参数。
...
//    }
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.OAS_30) // v2 不同
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.lsd.springboot_learning.controller")) // 设置扫描路径
                .build();
    }
